...
// let userPrompt = Number(prompt("Enter number to guess it is EVEN or ODD"));
...
// let userPrompt = prompt("Enter some word");
...
// let user = Number(prompt("Enter your score"));
...
// let userPrompt = Number(prompt("Enter some number"));
...
// else console.log(`Entered number ${userPrompt} is ZERO`);
...
// let userPrompt = Number(prompt("Enter first number"));
// let secondPrompt = Number(prompt("Enter second number"));
// let division;
...
// 9. დაწერეთ პროგრამა, რომელიც მომხმარებელს შეეკითხება თავის ასაკს და დაადგენს არის თუ არა 18 წლის ან უფრო მეტის. თუ არის, გამოპრინტეთ "Adult", თუარადა - "Minor".
...
// let userPrompt = prompt("Enter A, B, C, D, E, F").toUpperCase();
...
// let userPrompt = Number(prompt("Enter numbers from 1 to 12"));
